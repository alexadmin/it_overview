...
- if share becomes inaccessible because of network reasons, whole OS may hung, you can't even check free disk space with 

```df -h```

or list some directories and application may crash.
